...
import { ArrowUpRight, Globe, Github, BookOpen } from "lucide-react";
	...
	return (
		<Section id={S.work} title="Work">
			<ul className="space-y-3">
				{visible.map((p, i) => (
					<li key={p.name} style={{ animationDelay: `${i * 60}ms` }} className="animate-in fade-in slide-in-from-bottom-1 duration-400">
						<Card size="sm" className="transition-transform duration-200 hover:scale-[1.01] hover:shadow-sm">
							<CardHeader>
								<CardTitle>
