...
cover: /blog/blue-green-deployments.webp
---
...
![A diagram showcasing what is explained above](/blog/blue-green-diagram.webp)

And this is repeated till eternity ✨ Here is the graph of the same scenario:

![A graph showcasing how the traffic switching from one server to another over time](/blog/traffic-distribution-blue-green.webp)
...
![Diagram showcasing how traffic is unaffected even if the application crashes since instant roll-backs are possible](/blog/blue-green-downtime.webp)
