...
![Spongebob making a rainbow with his hands that says "Open Source"](/blog/spongebob-open-source.webp)
...
![A GIF mocking Linux's Window Servers](/blog/mocking-linux-users.webp)
...
![Meme depicting the pride of getting a job via Open Source](/blog/opensource-job.webp)
...
![Meme depicting the pride of contributing to Open Source](/blog/opensource-resume.webp)
...
![Sarcastic meme depicting developers preferring Open Source over project building to learn skills.](/blog/opensource-skills.webp)
...
![Sarcastic meme depicting developers skipping programming fundamentals for Open Source](/blog/opensource-attraction.webp)
...
![Meme referencing Indian pop-culture to denote the hypocrisy of "beginners can't contribute to open source"](/blog/opensource-beginners.webp)
...
![Meme depicting people contributing to ReactJs after reading this article.](/blog/opensource-big-contributions.webp)
...
![Diagram showing that open-source contributions can add value through code (features, refactoring, bug fixes, DX improvements) or no-code (docs, education, community, triaging).](/blog/no-code-contribution.webp)
...
![Lets Do This](/blog/lets-do-this.webp)
