...
- Debian (Parent of Ubuntu):
  ...
  ![A Screenshot of Debian with GNOME](/blog/debian-with-gnome.webp)
...
- Fedora
  ...
  ![Fedora Linux with GNOME](/blog/fedora-with-gnome.webp)
...
- Arch
  ...
  ![Arch Linux Desktop](/blog/arch-linux.webp)
...
![A minions meme highlighting the open source feature comically](/blog/minions-opensource.webp)
...
![An example of a customized Linux Desktop](/blog/linux-rice.webp)

My desktop looks like this:

![Krish's Fedora with KDE Configuration](/blog/krishs-fedora-desktop.webp)
...
![Meme depicting the power unlocked after mastering linux](/blog/linux-power-users.webp)
