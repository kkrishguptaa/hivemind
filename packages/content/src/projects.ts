...
`,
  },
  {
    ...
    deployedUrl: 'https://poems.krishg.com',
    content: `
`,
  },
  {
    name: 'Icarus',
    shortDescription:
      'Platformer game built in PhaseJS, inspired by the Greek myth of Icarus but with a twist, every few levels the player has to choose a power to sacrifice to keep flying, and the game can only be beaten if you have the right strategy for which powers to sacrifice at which levels.',
...
`,
  },
  {
    name: 'Mnemo',
    shortDescription:
      'Golang CLI to help you Save snips of information under various categories to remember them later',
